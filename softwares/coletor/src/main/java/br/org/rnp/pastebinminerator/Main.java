package br.org.rnp.pastebinminerator;

import java.util.ArrayList;
import java.util.HashMap;

import br.org.rnp.pastebinminerator.dao.temporary.PasteKeyTemporarySetDAO;
import br.org.rnp.pastebinminerator.minner.ExecutionManager;
...
public class Main {
    public static void main(String[] args) {
        ...
        ExecutionManager executionManager = new ExecutionManager(numberOfPastes, numberOfSeconds, languages);
