...
public class PasteJpaDAO extends GenericJpaDAO<Paste, Long> {
    ...
    public List<Paste> getPasteAmount(int amount) throws Exception {
            Query query = entityManager.createQuery("select p from paste p", Paste.class);
            query.setMaxResults(amount);
            return (List<Paste>)query.getResultList();
    }
}