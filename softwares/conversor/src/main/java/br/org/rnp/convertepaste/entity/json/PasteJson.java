 ...
 * @author felipevr
 */
public class PasteJson   implements Serializable {
    ...
    private String text;
    private Set<ReasonJson> reasons;
    private Set<PasteEntityJson> entities;
    private boolean analyzed;
    private double relevancy;

    public PasteJson() {
        super();
        reasons = new TreeSet<ReasonJson>();
        entities = new TreeSet<PasteEntityJson>();
    }
     ...
     */
    public Set<ReasonJson> getReasons() {
        return this.reasons;
    }
     ...
     */
    public void setReasons(Set<ReasonJson> reasons) {
        if (reasons == null) {
            return;
        }
    ...
    public Set<PasteEntityJson> getEntities() {
        return entities;
    }

    public void setEntities(Set<PasteEntityJson> entities) {
